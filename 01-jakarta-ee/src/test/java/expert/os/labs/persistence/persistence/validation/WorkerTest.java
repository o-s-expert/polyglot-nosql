...
class WorkerTest {
    ...
    void shouldNotCreateWorkerWithBlankNickname() {
        Worker worker = Worker.builder().nickname("")
                .name("John Doe").working(true).bio("I am a software engineer")
                .age(30).email("email@os.expert").salary(Money.of(usd, 10)).build();
    ...
    void shouldNotCreateWorkerWithNegativeSalary() {
        Worker worker = Worker.builder().nickname("jonhdoe").name("John Doe").working(true)
                .bio("I am a software engineer").age(30).email("email@os.expert")
    ...
    @Test
    void shouldSuccessfullyCreateWorker(){
        Worker worker = Worker.builder().nickname("jonhdoe").name("John Doe").working(true)
                .bio("I am a software engineer").age(30).email("email@os.expert")
